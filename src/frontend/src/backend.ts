...
import type { ExternalBlob as _ExternalBlob, MobileListing as _MobileListing, SubmitListingInput as _SubmitListingInput, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllListings(): Promise<Array<MobileListing>> {
        if (this.processError) {
            try {
    ...
    async getListingById(arg0: bigint): Promise<MobileListing | null> {
        if (this.processError) {
            try {
    ...
    async getNewListingsCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getNewListingsCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStorageRates(): Promise<Array<StorageRate>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStorageRates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitListing(arg0: SubmitListingInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitListing(to_candid_SubmitListingInput_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateListingStatus(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updatePickupDateTime(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePickupDateTime(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStorageRate(arg0: string, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStorageRate(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MobileListing_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MobileListing): Promise<MobileListing> {
...
async function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MobileListing]): Promise<MobileListing | null> {
    return value.length === 0 ? null : await from_candid_MobileListing_n9(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    address: string;
    modelName: string;
    mobilePhoto: [] | [_ExternalBlob];
    brand: string;
    phoneNumber: string;
    motherboardPhoto: [] | [_ExternalBlob];
    pickupDateTime: [] | [string];
    condition: string;
}): Promise<{
    id: bigint;
    ...
    return {
        ...
        mobilePhoto: record_opt_to_undefined(await from_candid_opt_n11(_uploadFile, _downloadFile, value.mobilePhoto)),
        brand: value.brand,
        phoneNumber: value.phoneNumber,
        motherboardPhoto: record_opt_to_undefined(await from_candid_opt_n11(_uploadFile, _downloadFile, value.motherboardPhoto)),
        pickupDateTime: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.pickupDateTime)),
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MobileListing>): Promise<Array<MobileListing>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MobileListing_n9(_uploadFile, _downloadFile, x)));
}
function to_candid_SubmitListingInput_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubmitListingInput): _SubmitListingInput {
...
function to_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        mobilePhotoBlobId: value.mobilePhotoBlobId ? candid_some(value.mobilePhotoBlobId) : candid_none(),
        storage: value.storage,
        description: value.description,
        sellerName: value.sellerName,
        address: value.address,
        modelName: value.modelName,
        motherboardPhotoBlobId: value.motherboardPhotoBlobId ? candid_some(value.motherboardPhotoBlobId) : candid_none(),
        brand: value.brand,
        phoneNumber: value.phoneNumber,
        condition: value.condition
    };
